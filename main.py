...
def monitorar_jogos_ao_vivo():
    ...
    while True:
        try:
            ...
            if not jogos:
                print("Nenhum jogo ao vivo. Próxima checagem em 2 minutos...")
            
            # CORRIGIDO: mudado 'jobs' para 'jogos' abaixo
            for jogo in jogos:
